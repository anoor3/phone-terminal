...
| # | Task | Status | Commit |
|---|------|--------|--------|
| 2 | Scaffold Fastify + @fastify/websocket + TypeScript | ⬜ Pending | — |
| 3 | Postgres schema (devices, sessions, audit_log) + migrations | ⬜ Pending | — |
| 4 | Redis pairing store module (set/get/expire with TTL) | ⬜ Pending | — |
| 5 | POST /api/pair/init endpoint | ⬜ Pending | — |
| 6 | WebSocket handler with Origin check + rate limiting | ⬜ Pending | — |
| 7 | WS cli_hello handler | ⬜ Pending | — |
| 8 | WS phone_claim handler (single-use token) | ⬜ Pending | — |
| 9 | Verification code generation + code_submit (5 attempts max) | ⬜ Pending | — |
...
|------|--------|-------------|
| 2026-07-06 | (pending) | Task 1: Initialize monorepo structure |
